...
Estudo dos cinco princípios SOLID de design orientado a objetos, com exemplos práticos implementados em **Dart**. Cada princípio acompanha um arquivo `.dart` com o código de exemplo e um arquivo `.md` com a explicação correspondente.
...
```
.
├── 1-SRP-single-responsibility-principle.dart
├── 1-SRP-single-responsibility-principle.md
├── 2-OCP-open-close-principle.dart
├── 2-OCP-open-close-principle.md
├── 3-LSP-liskov-substituition-principle.dart
├── 3-LSP-liskov-substituition-principle.md
├── 4-ISP-interface-segregation-principle.dart
├── 4-ISP-interface-segregation-principle.md
├── 5-DIP-dependency-inversion-principle.dart
└── 5-DIP-dependency-inversion-principle.md
```

## Princípios

1. [Single Responsibility Principle (SRP)](1-SRP-single-responsibility-principle.md)
2. [Open/Closed Principle (OCP)](2-OCP-open-close-principle.md)
...
[marcio-diniz](https://github.com/marcio-diniz)
